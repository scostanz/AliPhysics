...
Int_t ptBWeight=kNoPtBWei;//kFONLL5overLHC19c3;
Bool_t useMultWeight=kFALSE;//kTRUE;
...
void ComputeEfficiencyFromCombinHF(){
  ...
  TFile* out=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"recreate");
  //  TFile* out=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"recreate");
  hAccToy->Write();
  out->Close();
  ...
  if(hEventMultZv){
    ...
    hRatioZvEv->Draw();
    cev->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/FracEvSel%s.pdf",dataset.Data(),suffix.Data()));
    //    cev->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/FracEvSel%s.pdf",dataset.Data(),suffix.Data()));
  }
  ...
  TFile* outup=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"update");
  //  TFile* outup=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"update");
  outup->ls();
  ...
  hRatioEff->DrawCopy();
  cpf->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/EfficVsPt_PromptFd_%s.pdf",dataset.Data(),suffix.Data()));
  //  cpf->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/EfficVsPt_PromptFd_%s.pdf",dataset.Data(),suffix.Data()));
...
void ComputeAndWriteEff(TList* l, TString dCase, TString var3){
  ...
  t3->SetTextColor(4);
  t3->Draw();
  c1e->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/EfficVsPt_%s_%s.pdf",dataset.Data(),suffix.Data(),dCase.Data()));
  //  c1e->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/EfficVsPt_%s_%s.pdf",dataset.Data(),suffix.Data(),dCase.Data()));
  ...
  t3->Draw();
  c2e->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/EfficVs%s_%s_%s.pdf",dataset.Data(),var3.Data(),suffix.Data(),dCase.Data()));
  //  c2e->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/EfficVs%s_%s_%s.pdf",dataset.Data(),var3.Data(),suffix.Data(),dCase.Data()));
  ...
  if(var3=="Mult"){
    ...
    funcPtWeight->Draw();
    cwp->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/EfficVsPtMultBins_%s_%s.pdf",dataset.Data(),suffix.Data(),dCase.Data()));
    //    cwp->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/EfficVsPtMultBins_%s_%s.pdf",dataset.Data(),suffix.Data(),dCase.Data()));
    ...
    cw->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/Effic%sVsMultPtBins_%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
    //    cw->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/Effic%sVsMultPtBins_%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
  }else{
  ...
  if(var3=="Mult"){
    ...
    ceff->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/Effic%sWithMultWeights%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
    //    ceff->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/Effic%sWithMultWeights%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
    ...
    ceff2->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/figures/Effic%sWithMultAndPtWeights%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
    //    ceff2->SaveAs(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/figures/Effic%sWithMultAndPtWeights%s.pdf",dataset.Data(),dCase.Data(),suffix.Data()));
  }else{
  ...
  TFile* out=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/PID_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"update");
  //  TFile* out=new TFile(Form("~/alice/D0_pp13TeV/results/efficiency/central_cuts/%s/outputEff%s.root",dataset.Data(),suffix.Data()),"update");
  hEffVsPtR->Write();
