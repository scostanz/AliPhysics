...
Int_t saveCanvasAsPdf=1;   //0=none, 1=main ones, 2=all
...
AliHFInvMassFitter* ConfigureFitter(TH1D* histo, Int_t iPtBin, Int_t backcase, Double_t minFit, Double_t maxFit, Bool_t isDirect=kFALSE){
  ...
  if(correctForRefl){
    ...
    cTest->SaveAs(Form("%s/cTest%d.pdf",outdir.Data(),iPtBin));
 
    delete hmasstemp;
    printf("=========== refl integral: %f\n",hReflModif->Integral(hReflModif->FindBin(minFit*1.0001),hReflModif->FindBin(maxFit*0.999)));
    ...
    cTest->SaveAs(Form("%s/ReflectionConfig_PtBin%d.pdf",outdir.Data(),iPtBin));
...
void ProjectCombinHFAndFit(){
  ...
  TH3F* h3dmepp=(TH3F*)l->FindObject(Form("hMassVsPtVs%sMELSpp",var.Data())); // manca
  TH3F* h3dmemm=(TH3F*)l->FindObject(Form("hMassVsPtVs%sMELSmm",var.Data())); // manca
  ...
  if(filMC && filMC->IsOpen()){
    ...
    printf("In %s, looking for %s\n", dirNameMC.Data(),lstNameMC.Data());
  ...
  TFile* fout=new TFile(Form("%s/outputMassFits_%s_%s.root",outdir.Data(),sigConf.Data(),suffix.Data()),"recreate");
  current->cd();
...
//   path.Append("/figures/LHC2016/templ");
  TString path = outdir;
  if(gSystem->AccessPathName(path.Data())){ 
    gROOT->ProcessLine(Form(".!mkdir -p %s",path.Data()));  
  }

  if(saveCanvasAsPdf>0){
    c1->SaveAs(Form("%s/InvMassSpectra_%s_%s_NoBkgSub.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c2->SaveAs(Form("%s/InvMassSpectra_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c3->SaveAs(Form("%s/InvMassSpectra_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c4->SaveAs(Form("%s/InvMassSpectra_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c2sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c3sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    c4sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    if(tryDirectFit){
      c5->SaveAs(Form("%s/InvMassSpectra_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c5sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
    }

    if(saveCanvasAsPdf>1){
      c2residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c3residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c4residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));

      c2residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c3residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c4residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));

      c2pulls->SaveAs(Form("%s/PullDistribution_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c3pulls->SaveAs(Form("%s/PullDistribution_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c4pulls->SaveAs(Form("%s/PullDistribution_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));

      c2pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_Rot.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c3pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_LS.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      c4pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_EM.pdf",path.Data(),sigConf.Data(),suffix.Data()));

      if(tryDirectFit){
	c5residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
	c5residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
	c5pulls->SaveAs(Form("%s/PullDistribution_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
	c5pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_SB.pdf",path.Data(),sigConf.Data(),suffix.Data()));
      }
    }
  }
  ...
  // save also .root
  if(saveCanvasAsRoot){
    c2->SaveAs(Form("%s/InvMassSpectra_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3->SaveAs(Form("%s/InvMassSpectra_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4->SaveAs(Form("%s/InvMassSpectra_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));
    c2sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));

    c2residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));

    c2residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));

    c2pulls->SaveAs(Form("%s/PullDistribution_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3pulls->SaveAs(Form("%s/PullDistribution_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4pulls->SaveAs(Form("%s/PullDistribution_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));

    c2pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_Rot.root",path.Data(),sigConf.Data(),suffix.Data()));
    c3pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_LS.root",path.Data(),sigConf.Data(),suffix.Data()));
    c4pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_EM.root",path.Data(),sigConf.Data(),suffix.Data()));

    if(tryDirectFit){
      c5->SaveAs(Form("%s/InvMassSpectra_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
      c5sub->SaveAs(Form("%s/InvMassSpectraFitSubtr_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
      c5residuals->SaveAs(Form("%s/ResidualDistribution_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
      c5residualTrend->SaveAs(Form("%s/residualTrendvsMass_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
      c5pulls->SaveAs(Form("%s/PullDistribution_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
      c5pullTrend->SaveAs(Form("%s/pullTrendvsMass_%s_%s_SB.root",path.Data(),sigConf.Data(),suffix.Data()));
    }
  }
  ...
  legry->Draw();
  if(saveCanvasAsPdf>0) cry->SaveAs(Form("%s/RawYield_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cry->SaveAs(Form("%s/RawYield_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
  ...
  legry->Draw();
  if(saveCanvasAsPdf>0) cch2->SaveAs(Form("%s/ChiSq_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cch2->SaveAs(Form("%s/ChiSq_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
  ...
  // Susanna
  TH1F* hRatioLSToRot=(TH1F*)hRawYieldLS->Clone("hRatioLStoRot");
  TH1F* hRatioRotToRot=(TH1F*)hRawYieldRot->Clone("hRatioRottoRot");
  TH1F* hRatioMEToRot=(TH1F*)hRawYieldME->Clone("hRatioMEtoRot");
  TH1F* hRatioSBToRot=(TH1F*)hRawYieldSB->Clone("hRatioSBtoRot");
  for(Int_t ib=1; ib<=hRawYieldRot->GetNbinsX(); ib++){
    Double_t yrot=hRawYieldRot->GetBinContent(ib);
    if(yrot>0.){
      hRatioLSToRot->SetBinContent(ib,hRawYieldLS->GetBinContent(ib)/yrot);
      hRatioLSToRot->SetBinError(ib,hRawYieldLS->GetBinError(ib)/yrot);
      hRatioMEToRot->SetBinContent(ib,hRawYieldME->GetBinContent(ib)/yrot);
      hRatioMEToRot->SetBinError(ib,hRawYieldME->GetBinError(ib)/yrot);
      hRatioRotToRot->SetBinContent(ib,hRawYieldRot->GetBinContent(ib)/yrot);
      hRatioRotToRot->SetBinError(ib,hRawYieldRot->GetBinError(ib)/yrot);
      hRatioSBToRot->SetBinContent(ib,hRawYieldSB->GetBinContent(ib)/yrot);
      hRatioSBToRot->SetBinError(ib,hRawYieldSB->GetBinError(ib)/yrot);
    }
  }
  ...
  if(saveCanvasAsPdf>0) cry2->SaveAs(Form("%s/RawYieldAndRatios_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cry2->SaveAs(Form("%s/RawYieldAndRatios_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
  ...
  if(saveCanvasAsPdf>0) cry3->SaveAs(Form("%s/RawYieldRatiosAndUnc_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cry3->SaveAs(Form("%s/RawYieldRatiosAndUnc_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));

  // Susanna - ratio to Rot added
  TCanvas* cryRot2=new TCanvas("cryRot2","RawYield+Ratios",1400,700);
  cryRot2->Divide(2,1);
  cryRot2->cd(1);
  gPad->SetLeftMargin(0.15);
  gPad->SetRightMargin(0.05);    
  ...
  legry->Draw();
  cryRot2->cd(2);
  hRatioLSToRot->SetStats(0);
  hRatioLSToRot->SetMinimum(0.3);
  hRatioLSToRot->SetMaximum(1.7);
  hRatioLSToRot->GetYaxis()->SetTitle("Ratio To Rot");
  hRatioLSToRot->Draw("same");
  hRatioRotToRot->Draw("same");
  hRatioMEToRot->Draw("same");
  hRatioSBToRot->Draw("same");
  if(saveCanvasAsPdf>0) cryRot2->SaveAs(Form("%s/RawYieldAndRatiosToRot_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cryRot2->SaveAs(Form("%s/RawYieldAndRatiosToRot_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
  ...
  TCanvas* cryRot3=new TCanvas("cryRot3","RawYield+Ratios+Unc",1800,600);
  cryRot3->Divide(3,1);
  cryRot3->cd(1);
  gPad->SetLeftMargin(0.15);
  gPad->SetRightMargin(0.05);    
  ...
  if(saveCanvasAsPdf>0) cryRot3->SaveAs(Form("%s/RawYieldRatiosToRotAndUnc_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cryRot3->SaveAs(Form("%s/RawYieldRatiosToRotAndUnc_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
  ...
  legryBC->Draw();
  if(saveCanvasAsPdf>0) cryBC->SaveAs(Form("%s/RawYieldBC_%s_%s.pdf",path.Data(),sigConf.Data(),suffix.Data()));
  if(saveCanvasAsRoot) cryBC->SaveAs(Form("%s/RawYieldBC_%s_%s.root",path.Data(),sigConf.Data(),suffix.Data()));
