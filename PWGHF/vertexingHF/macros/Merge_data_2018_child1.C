...
TString inputdir = "~/alice/D0_pp13TeV/ROOTfiles/data/lowpt/LHC2018_AOD208_bdefghijklmnop/23nov";
TString suffix[45] = {"285978","285979","285980","286014","286025","286027","286064","286124","286127","286129","286130","286159","286198","286199","286201","286202","286203","286229","286230","286231","286254","286257","286258","286261","286263","286282","286284","286287","286288","286289","286308","286309","286310","286311","286312","286313","286314","286336","286337","286340","286341","286345","286348","286349","286350"};

void Merge_data_2018_child1(){
  
  TString dirtomerge="";

  TFile * fi=new TFile(Form("%s/AnalysisResults_%s.root",inputdir.Data(),suffix[0].Data()));
  cout << "Opening file: " << Form("%s/AnalysisResults_%s.root",inputdir.Data(),suffix[0].Data()) << endl;
  ...
  mga.OutputFile(Form("%s/AnalysisResults_child1_rl1.root",inputdir.Data()));
  for (int i=0; i<45;i++) {
    cout << "Adding file " << Form("%s/AnalysisResults_%s.root",inputdir.Data(),suffix[i].Data()) << endl;
    mga.AddFile(Form("%s/AnalysisResults_%s.root",inputdir.Data(),suffix[i].Data()));
  }
